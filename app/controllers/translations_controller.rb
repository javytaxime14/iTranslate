class TranslationsController < ApplicationController
  ...
  def api_request(path, method: :get, body: nil)
    params = {
      headers: {
        'x-rapidapi-key': '0172f7bceemsh86acdb1a42a61d3p1a1643jsn63fe3f514157',
  ...
  def translate_params
    params.permit(:source, :source_language, :destination_language, :translation, :authenticity_token)
  end
end
